...
import com.example.xero.cardtradeapp.CardsFragment.OnListFragmentInteractionListener;
...
public class MyCardsRecyclerViewAdapter extends RecyclerView.Adapter<MyCardsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCardsRecyclerViewAdapter(List<Card> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
